...
#define WRITE_LENGTH AUDIO_REC*NUM_CHANNELS*2
...
FIL myFile;
UINT byteCount;
int32_t FrameCount = 1000;// AUDIO_REC * 40;
//int32_t toneCount = 131072/8;
FRESULT fRet = 0;
int pass = 0;
char *fname = "hello1.wav";
...
//		AudioBuf[i*4 + 3] = rfinal >> 8;
//		AudioBuf[i*4 + 2] = rfinal & 0xff;
